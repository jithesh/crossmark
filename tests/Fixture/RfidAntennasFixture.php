 ...
 *
 */
class RfidAntennasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'rfidcontroller_id' => ['type' => 'uuid', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'rfid_antennas_customer_id_fkey' => ['type' => 'foreign', 'columns' => ['customer_id'], 'references' => ['customers', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'rfid_antennas_rfidcontroller_id_fkey' => ['type' => 'foreign', 'columns' => ['rfidcontroller_id'], 'references' => ['rfid_controllers', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public $records = [
        [
            'id' => 'ee79a924-0507-484e-8a1b-67556e356544',
            ...
            'customer_id' => '5dcc49c0-106c-42be-a3a2-d13e3a8e93e4',
            'rfidcontroller_id' => 'be72bc78-e8bd-429a-8bae-8908ac0fed94'
        ],
    ];
}
