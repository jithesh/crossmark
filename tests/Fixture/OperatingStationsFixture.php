...
/**
 * OperatingStationsFixture
 *
 */
class OperatingStationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'operating_stationid' => ['type' => 'string', 'length' => null, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'operating_stations_customer_id_fkey' => ['type' => 'foreign', 'columns' => ['customer_id'], 'references' => ['customers', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public $records = [
        [
            'id' => 'b1409282-fb9d-4139-91f7-17521a0967ad',
            ...
            'customer_id' => '25a2ba84-f671-4562-a2df-04c3f6bb4795',
            'operating_stationid' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
