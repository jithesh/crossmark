 ...
 *
 */
class RfidTagsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'terminal_id' => ['type' => 'uuid', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null],
        ...
        'make' => ['type' => 'string', 'length' => null, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        'type' => ['type' => 'string', 'length' => null, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'rfid_tags_terminal_id_fkey' => ['type' => 'foreign', 'columns' => ['terminal_id'], 'references' => ['terminals', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public $records = [
        [
            'id' => 'eb9e35f0-e05f-47bc-939b-3269d901f197',
            'terminal_id' => '5bb7a01f-82bc-4212-8271-e53b0a3c83b3',
