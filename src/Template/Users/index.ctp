    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('createdip') ?></th>
                <th scope="col"><?= $this->Paginator->sort('modiifedip') ?></th>
                <th scope="col"><?= $this->Paginator->sort('dateformat') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($user->createdip) ?></td>
                <td><?= h($user->modiifedip) ?></td>
                <td><?= h($user->dateformat) ?></td>
